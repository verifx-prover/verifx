...
import be.vub.kdeporre.verifx.{ClassNotFound, FieldDoesNotExist, MatchError, MethodNotFound, ParseError, TypeError, UnknownIdentifierError}
...
object Types {
  ...
  final case class Classes(classTable: ClassTable = Map(),
     ...
     */
    def +(enumIR: Enum): Classes = this.copy(classDefinitionOrder = classDefinitionOrder.appended(enumIR))
