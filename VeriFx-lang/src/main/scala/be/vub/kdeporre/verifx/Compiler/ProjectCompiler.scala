...
import be.vub.kdeporre.verifx.Analysis.Proofs.{Aborted, ProofName, ProofResult, Proved, Rejected}
import be.vub.kdeporre.verifx.Compiler.ProgramCompiler.FileName
import be.vub.kdeporre.verifx.Compiler.ProjectCompiler.{ClassName, ObjectName}
