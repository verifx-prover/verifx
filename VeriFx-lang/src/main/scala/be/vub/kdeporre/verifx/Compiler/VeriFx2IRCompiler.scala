...
import be.vub.kdeporre.verifx.{ClassNotFound, FieldDoesNotExist, IllegalArgumentException, IllegalOperationError, MatchError, MethodNotFound, ParseError, TypeError}
...
case class MethodCompiler()(implicit thisClass: Type, classTable: Classes) {
  ...
  /**
   * Transforms a method declaration into an IR [[be.vub.kdeporre.verifx.Compiler.IR.Decl.Method]].
   */
  ...
  /**
   * Transforms a method definition into an IR [[be.vub.kdeporre.verifx.Compiler.IR.Defn.MethodDef]].
   */
